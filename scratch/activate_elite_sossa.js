...
async function activateElite(email) {
    try {
        ...
        console.log(`¡Plan Elite activado exitosamente en Firestore para ${email}!`);
    } catch (error) {
        console.error(`Error al activar Plan Elite para ${email}:`, error);
    }
}

activateElite('sossabeatz1@gmail.com');
