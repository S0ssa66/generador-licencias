...
*   **Checkout del Cliente:** [[3_Recursos/Codigo_Beatss/checkout.js]] (Manejo de carrito y botones de PayPhone / Deuna).
*   **Webhooks de Pago (Backend):**
    *   Deuna: [[3_Recursos/Codigo_Beatss/api/payments/deuna/webhook.js]] (Procesamiento del pago de Deuna).
    *   PayPhone: [[3_Recursos/Codigo_Beatss/api/payments/payphone/webhook.js]] (Procesamiento del pago de PayPhone).
*   **Facturación SRI (Python Backend):**
    *   Esquema de facturación: [[3_Recursos/Codigo_Beatss/sri_invoicing.py]]
    *   Servicios SRI (Firma .p12): [[3_Recursos/Codigo_Beatss/sri_service.py]]
