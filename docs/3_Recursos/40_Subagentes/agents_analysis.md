...
Para una navegación eficiente, los 21 agentes han sido agrupados en **6 Categorías Funcionales**.

---

## 📋 Resumen de Agentes por Categoría
...
| **`branding_specialist`** | Especialista en Marca Personal y Relaciones Públicas | Activo |
...
### Agente de Integraciones y Firebase (`integrator`)
...
### Agente de Refactorización Modular (`refactor_expert`)
...
### Agente de Webhooks y Automatización (`automation_expert`)
...
### Agente de Infraestructura y DevOps (`devops_admin`)
...
### Agente de Desarrollo Mobile (`mobile_developer`)
...
### Agente de Audio y Procesamiento Digital (`audio_dsp_expert`)
...
### Agente de Datos y Migraciones (`data_engineer`)
...
### Agente de Diseño y UI/UX (`designer`)
...
### Agente de Documentos y PDF (`document_expert`)
...
### Agente de QA y Pruebas Unitarias (`qa_tester`)
...
### Agente de Analítica de Negocio y Dashboard (`business_analyst`)
...
### Agente de Tráfico, Ventas y Embudos de Conversión (`growth_hacker`)
...
### Agente de Copywriting y Localización (`marketing_copywriter`)
...
### Agente de SEO y Rendimiento Web (`seo_optimizer`)
...
### Agente Especialista en Marca Personal y Relaciones Públicas (`branding_specialist`)
...
### Agente de Asesoría Legal y Derechos de Autor (`legal_advisor`)
...
### Agente Gestor de Derechos y Reclamaciones de Copyright (`rights_manager`)
...
### Agente de Soporte al Cliente y Guías de Uso (`support_helper`)
...
### Agente de Gestión del Conocimiento y Obsidian (`obsidian_expert`)
